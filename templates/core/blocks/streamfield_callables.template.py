...
def get_common_streamfield_blocks():
    ...
    """
    from {package_name}.core.blocks.core import STREAMFIELD_COMMON_BLOCKS
    from {package_name}.core.registry import get_registered_blocks
...
def get_hero_streamfield_blocks():
    ...
    """
    from {package_name}.core.blocks.core import HERO_STREAMFIELD_BLOCKS
