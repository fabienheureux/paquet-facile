"""
Custom field definitions for {package_name} content manager.
"""
...
class DynamicStreamField(StreamField):
    ...
    Usage:
        ...
        # In models.py
        from {package_name}.core.fields import DynamicStreamField
        from {package_name}.core.blocks.core import get_common_blocks
